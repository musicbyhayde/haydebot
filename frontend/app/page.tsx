...
export default function Home() {
  ...
  return (
    <div className="flex h-[100dvh] w-screen overflow-hidden bg-slate-50 dark:bg-[#0b141a] text-slate-900 dark:text-slate-100 transition-colors" dir="rtl">
      <div className={clsx(
          ...
          <div className="flex-1 overflow-y-auto bg-slate-50 dark:bg-[#0b141a] p-4 md:p-8" dir="rtl">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-6 flex items-center gap-3">
                <button onClick={() => setMobileMenuOpen(true)} className="md:hidden p-2 bg-white dark:bg-[#111b21] rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:bg-[#0b141a] transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" x2="20" y1="12" y2="12" /><line x1="4" x2="20" y1="6" y2="6" /><line x1="4" x2="20" y1="18" y2="18" /></svg>
                </button>
                <h1 className="text-xl md:text-3xl font-extrabold text-slate-900 dark:text-slate-100">לוח משימות 📋</h1>
              </div>
